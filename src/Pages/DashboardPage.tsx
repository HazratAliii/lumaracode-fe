...
const Sidebar = () => {
  return (
    <div className="w-64 bg-white shadow-md">
      ...
      <nav className="mt-8">
        <SidebarItem label="Dashboard" icon="🏠" active={true} />
        <SidebarItem label="Order List" icon="📋" active={false} />
        <SidebarItem label="Analytics" icon="📊" active={false} />
        <SidebarItem label="Foods" icon="🍔" active={false} />
        <SidebarItem label="Calendar" icon="📅" active={false} />
        <SidebarItem label="Chat" icon="💬" active={false} />
        <SidebarItem label="Wallet" icon="💼" active={false} />
      </nav>
    </div>
  );
};
